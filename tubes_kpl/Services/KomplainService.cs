...
public class KomplainService : IKomplainService
{
    ...
    public async Task<bool> ResponKomplainAsync(int komplainId, string respons, int dosenId)
    {
        ...
        return await Task.Run(async () =>
        {
            ...
            // DbC Postcondition
            Contract.Ensures(!ok || true); // simplified
            return ok;
        });
    }
...
{
    // Code Reuse: Satu fungsi _save digunakan semua metode notifikasi
    ...
    {
        // Code Reuse: Reuse SaveNotifikasiAsync untuk setiap penerima
